...
<style>
	...
	.card{box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); background:pink}
</style>
...
<div class="row">
	...
	<div class="col-lg-7">
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			...
			<div class="panel panel-primary">
			  <div class="panel-heading">Current Offerings</div>
			...
			<div class="panel panel-primary">
			  <div class="panel-heading">Currently Hired Employees</div>
			  <div class="panel-body"><h4>
                  <table style="width:100%">
                      <tr>
                          <td>Job Id</td>
			...
			<div class="panel panel-primary">
			  <div class="panel-heading">Previously Hired Employees</div>
			  <div class="panel-body"><h4>
                  <table style="width:100%">
                      <tr>
                          <td>Job Id</td>
