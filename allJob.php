...
<style>
	...
	.card{box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); background:red}
</style>
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="allFreelancer.php">Browse Employees</a></li>
...
<div class="row">
	...
	<div class="col-lg-3">
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
	        ...
	        <form action="allJob.php" method="post">
				<div class="form-group">
				  <center><button type="submit" name="recentJob" class="btn btn-warning">Latest entries</button></center>
				</div>
	        </form>

	        <form action="allJob.php" method="post">
				<div class="form-group">
				  <center><button type="submit" name="oldJob" class="btn btn-warning">Old entries</button></center>
				</div>
	        </form>
...
<div class="text-center" style="padding:4%;background:#222;color:#fff;margin-top:20px;">
	<div class="row">
			...
			<p><a href="allFreelancer.php">Browse Employees</a></p>
